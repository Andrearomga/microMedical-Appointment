...
from CloudHealt.Infrestructure.Routes.MedicalAppointmentsRoutes import medical_appointments_routes
...
class CamasTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.app.register_blueprint(medical_appointments_routes, url_prefix='/camas')
